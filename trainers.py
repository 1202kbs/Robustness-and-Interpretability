...
class Trainer():
    ...
    def train(self, n_epochs, p_epochs=10):
        ...
        for epoch in range(n_epochs):
            ...
            if (epoch + 1) % p_epochs == 0:
                ...
                print('Epoch : {:<3d} | Loss : {:.5f} | Accuracy : {:.5f} | Test Accuracy : {:.5f} | Adv Accuracy : {:.5f}'.format(epoch + 1, train_loss, train_acc, test_acc, adv_acc))
    ...
    def train_step(self, itr):
        ...
        batch_xs, batch_ys = np.copy(self.data_train[0][itr * self.batch_size:(itr + 1) * self.batch_size]), self.data_train[1][itr * self.batch_size:(itr + 1) * self.batch_size]
    ...
    def train(self, n_epochs, p_epochs=10):
        ...
        for epoch in range(n_epochs):
            ...
            if (epoch + 1) % p_epochs == 0:
                ...
                print('Epoch : {:<3d} | Enc Loss : {:.5f} | Dec Loss : {:.5f} | Disc Loss : {:.5f}'.format(epoch + 1, losses[0], losses[1], losses[2]))
